...
function the_breadcrumb() {  
    ...
    echo 'Estás en &raquo;  <a href="'.$url.'/" rel="home">Inicio</a> &raquo;';
    $dir = $url.'/';
    if(is_single() || is_category()) {
        ...
        foreach($url_array as $folder) {
            if($folder != 'category'){
                ...
                echo ' &raquo; <a href="'.$dir.'" rel="category tag">'.ucwords(str_replace("-", " ", $folder)) . '</a>  &raquo;';
            }
        }
    } else {
        ...
        foreach($url_array as $folder) {
            if($folder != 'tag' && $folder != 'author'){
                if(!is_numeric($folder)){
                    ...
                    echo ' &raquo; <a href="'.$dir.'">'.ucwords(str_replace("-", " ", $folder)) . '</a> &raquo; ';
                }
            }
        }
    }
